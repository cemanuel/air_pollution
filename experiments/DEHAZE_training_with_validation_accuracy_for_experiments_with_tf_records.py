...
experiment_directory_suffix = "DEHAZENET_experiment_final_presentation_webcamId_17603_with_regression_timesplit_with_3100_steps"
...
def initialize_params_for_experiment():
    ...
    params_initialization_for_training['type_of_model'] = 'DehazeNet'
...
for tf_record_for_training_ in list_of_tf_records_for_training:
    print(tf_record_for_training_)
for tf_record_for_dev_ in list_of_tf_records_for_dev:
    print(tf_record_for_dev_)
